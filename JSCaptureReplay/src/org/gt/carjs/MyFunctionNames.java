...
import org.gt.carjs.callbacks.AllNamesFinder;
import org.gt.carjs.callbacks.NameAnonyms;
...
public class MyFunctionNames implements CompilerPass, Serializable {
  ...
  public MyFunctionNames(AbstractCompiler compiler) {
